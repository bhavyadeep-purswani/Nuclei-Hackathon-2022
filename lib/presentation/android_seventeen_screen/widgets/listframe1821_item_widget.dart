...
class Listframe1821ItemWidget extends StatelessWidget {
  Listframe1821ItemWidget(this.listframe1821ItemModelObj);

  Listframe1821ItemModel listframe1821ItemModelObj;

  var controller = Get.find<AndroidSeventeenController>();
